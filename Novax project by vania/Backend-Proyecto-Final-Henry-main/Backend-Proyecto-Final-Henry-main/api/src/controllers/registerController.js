...
async function register(req, res) {
  ...
  //esto genera un codigo aleatorio que se lo manda por email
...
<body>
  ...
  //aca verifica si existe el usuario por username o email
  try {
